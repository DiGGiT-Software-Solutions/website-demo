...
!(function(t, e) {
            ...
            function(t, e, r) {
                ...
                if (!d) {
                    if (!(f = 'auto' === p.grid ? 0 : (p.grid || [1, U])[1])) {
                        for (
                            h = -U; h < (h = r[f++].getBoundingClientRect().left) && f < c;
                    ...
                    if (
                        ...
                        if (
                            ((i = ja(v % o)),
                                ...
                                ((s = ~~(v / o)) && s === v / o && ((i = g), s--),
                                    g < i && (i = g)),
                                (c = Tt(this._tTime, o)), !_ && this._tTime && c !== s && (c = s),
                                d && 1 & s && ((i = g - i), (p = 1)),
                                s !== c && !this._lock)
                        ) {
                            var T = d && 1 & c,
                            ...
                            if (
                                (s < c && (T = !T),
                                    ...
                                    (this._tTime = v), !e && this.parent && Ct(this, 'onRepeat'),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (_ = 0)), !_ && i && !e && (Ct(this, 'onStart'), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
                    ...
                    this._onUpdate && !e && Ct(this, 'onUpdate', !0),
                        ...
                        ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                            ...
                            ((!t && g) ||
                                ...
                                (Ct(
                                        this,
                                        v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0,
                                    ), !this._prom ||
        ...
        if (
            ...
            (u = new pt[t]()).init(
                ...
                (function _processVars(t, e, i, n, a) {
                    if (
                        (s(t) && (t = Qt(t, a, e, i, n)), !v(t) || (t.style && t.nodeType) || $(t) || J(t))
                    )
            ...
            if (
                (r(n) &&
                    (~n.indexOf('random(') && (n = ob(n)),
                        '=' === n.charAt(1) &&
                        ((!(c = ka(p, n) + (Ya(p) || 0)) && 0 !== c) || (n = c))), !f || p !== n || Wt)
            )
                return isNaN(p * n) || '' === n ?
                    (d || e in t || Q(e, n),
        ...
        Ht = function _initTween(t, e, r) {
            ...
            if (
                (!F || (P && g) || (g = 'none'),
                    ...
                    (t._from = !F && !!m.runBackwards), !F || (P && !m.stagger))
            ) {
                if (
                ...
                for (
                    t._pt = t._ptCache = 0, T = (A && w(T)) || (T && !A), n = 0; n < R.length; n++
                ) {
                    if (
        ...
        function Tween(e, r, i, n) {
            ...
            if (
                ((a._targets = C.length ?
                        ea(C) :
                        R(
                            'GSAP target ' + e + ' not found. https://greensock.com', !j.nullTargetWarn,
                        ) || []),
                    (a._ptLookup = []),
                    (a._overwrite = b),
                    x || T || y(_) || y(m))
                ...
                if (
                    ...
                    for (o = 0; o < h; o++)
                        ...
                        (u.delay =
                            (+Qt(m, _assertThisInitialized(a), o, f, C) || 0) - a._delay), !T &&
                        1 === h &&
                        u.delay &&
                ...
                if (p) {
                    if (
                        ...
                        if (((i = m), (l = this.timeline), this._repeat)) {
                            ...
                            a !== o &&
                                (l && this._yEase && Pb(l, u), !this.vars.repeatRefresh ||
                                    u ||
                                    this._lock ||
                                    ((this._lock = r = 1),
                        ...
                        this._onUpdate &&
                            ...
                            (_ && !this._onUpdate && Ca(this, t, 0, !0),
                                ...
                                (_ && !c) ||
                                !(m || c || u) ||
                                (Ct(this, m === d ? 'onComplete' : 'onReverseComplete', !0), !this._prom ||
            ...
            (e.resetTo = function resetTo(t, e, r, i) {
                ...
                return (
                    ...
                    (function _updatePropTweens(t, e, r, i, n, a, s) {
                        ...
                        if (!f)
                            for (
                                f = t._ptCache[e] = [], h = t._ptLookup, l = t._targets.length; l--;
    ...
    function Jd() {
        ...
        if (this.tfm) {
            ...
            a.svg &&
                (a.renderTransform(),
                    i.setAttribute('data-svg-origin', this.svgo || '')), !(t = Fe()) || t.isStart || n[lr] || (Id(n), (a.uncache = 1));
        }
    }
    ...
    function Td(e) {
        ...
        return (
            (r && (r.width || r.height)) || e.getBBox === Rd || (r = Rd.call(e, !0)), !r || r.width || r.x || r.y ?
            r :
            {
                x: +Sd(e, ['x', 'cx', 'x1']) || 0,
                y: +Sd(e, ['y', 'cy', 'y1']) || 0,
        ...
        return i === h || !u || pr[i] || pr[h] ?
            ...
            ('px' === h || p || (u = Zd(t, e, r, 'px')),
                ...
                ((l[f ? 'width' : 'height'] = 100 + (p ? h : i)),
                    (a = ~e.indexOf('adius') || ('em' === i && t.appendChild && !c) ?
                        t :
                        t.parentNode),
    ...
    var Ae,
        ...
        dr = function _checkPropPrefix(t, e, r) {
            ...
            for (
                t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(cr[n] + t in i);
